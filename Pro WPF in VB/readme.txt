...
Chapter 9
---------
XBAP projects have a hard-coded debug path. In order to successfully test the XBAP project on your computer, double-click My Project in the Solution Explorer, choose the Debug section, and update the path in the "Command line arguments" text box.
